...
class FeesControllerTest < ActionController::TestCase
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post :create, fee: { amount_paid: @fee.amount_paid, fee_paid_date: @fee.fee_paid_date, hearing_id: @fee.hearing_id }
    end
  ...
  test "should update fee" do
    patch :update, id: @fee, fee: { amount_paid: @fee.amount_paid, fee_paid_date: @fee.fee_paid_date, hearing_id: @fee.hearing_id }
    assert_redirected_to fee_path(assigns(:fee))
  end
